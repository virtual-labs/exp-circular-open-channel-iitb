...
function activity1() {
    ...
    <div style='margin-top: 2vw;'>
        ...
        <div class="fs-16px">
        <h5>Flow over Circular open channels</h5>
...
function start_act1() {
    ...
    <div class='collapse divide' style='style='margin-top: 2vw; 'width: 80%; margin: auto;' id='tb1-box'>
        ...
        <h5> Find the discharge through a circular channel having diameter ${d}m, depth of water is half of the diameter and bed slope as 1 in ${bed_slope}.</h5>
        ...
        <p style='text-align: center;'> <span style='display: inline-block;' >
            <span style='display: inline-block;' >
                $$ A = \\frac{\\pi}{4}D^2 * \\frac{1}{2} = \\frac{\\pi D^2}{8} $$
            </span>
...
function internal_calculations() {
    area = (Math.PI * Math.pow(d, 2)) / 8;
    perimeter = (Math.PI * d) / 2;
    m = area / perimeter;
...
function verify0() {
    ...
    if (!verify_values(parseFloat(parseFloat(inp4.value).toFixed(2)), parseFloat(c.toFixed(2)))) {
